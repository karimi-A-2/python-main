...
print("----------------------------------------------------------------------------")  # search(pattern , string)
#
match = re.search("string", "string")
...
# match = re.search("(\d+)\.(\d+)", "24.1632").groups()
# print(match)

# print("----------------------------------------------------------------------------")     # match.groupdict([dafault = None])
...
# print("----------------------------------------------------------------------------")      ## match.start([group]) & match.end([group])
...
# print("----------------------------------------------------------------------------")  ## match(pattern, string, flags=0)
...
# print("----------------------------------------------------------------------------")   ## fullmatch(pattern, string, flags=0)
...
# print("----------------------------------------------------------------------------")     ## findall(pattern, string, flags=0)
...
# print("----------------------------------------------------------------------------")     ## finditer(pattern, string, flags=0)
...
# print("----------------------------------------------------------------------------")       ## sub(pattern, repl, string, count=0, flags=0)
...
# print("----------------------------------------------------------------------------")       ## split(pattern, string, maxsplit=0, flags=0)
